$(function(){
    ...
    tinyMCE.init({
        ...
        template_replace_values: {
            username: "Manutenção Lira",
            staffid: "(83)99837-9516"
        }
    });
    
    $('.painel_btn').click(function(){
        $('.main_painel_nav').toggleClass('active');
        $('.painel_btn').toggleClass('active');
    });
    
    $('.main_painel_sidebar_menu li:has(ul)').click(function(){
        if($(this).hasClass('active')){
           $(this).removeClass('active');
           $(this).children('ul').slideUp();
        }else{
           $('.main_painel_sidebar_menu li ul').slideUp();
           $('.main_painel_sidebar_menu li').removeClass('active');
