...
/**
 * <b>Read.class:</b>
 * Classe responsável por leitura genericas no banco de dados!
 *  
...
class Read extends Conn {
    ...
    /**
     * <b>Exe Read:</b> Executa uma leitura simplificada com Prepared Statements. Basta informar o nome e
     * os termos da seleção e uma analize em cadeia (ParseString) para executar.
     * @param type $Tabela = Nome da Tabela
     * @param type $Termos = WHERE | ORDER | LIMIT :limit | OFFSET :offset
     * @param type $ParseString = link={$link}&link2={$link2}
     */
    ...
    /**
     * <b>Obter resultado:</b> Retorna um array com todos os resultados obtidos. Envelope primário númerico.
    ...
    /**
     * <b>Contar registros:</b> Retorna um número de registros encontrados pelo select!
